const cari = async () => {
	...
	let result = await fetch('http://3.83.203.203:5001/weather?key=AIzaSyCxQy3DFnDxNh3D_E8c0c1rrno_U_lzTcQ&query=' +ina);
...
const loadData = async () => {
	...
	let alamatElem = $('alamat');
	let ina = alamatElem.value;
	let result = await fetch('http://3.83.203.203:5001/forecast?key=AIzaSyCxQy3DFnDxNh3D_E8c0c1rrno_U_lzTcQ&query=' + ina);
	let json = await result.json();
	let list = json.list;
